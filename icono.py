...
#Música de fondo
pygame.mixer.music.load('sonido/sonido/intergalactic Odyssey.ogg')
...
#sonido
sonido_arriba = pygame.image.load('sonido/sonido/volume_up.png')
sonido_abajo = pygame.image.load('sonido/sonido/volume_down.png')
sonido_mute = pygame.image.load('sonido/sonido/volume_muted.png')
sonido_max = pygame.image.load('sonido/sonido/volume_max.png')
